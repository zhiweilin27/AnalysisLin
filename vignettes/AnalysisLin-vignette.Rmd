...
# Introduction
Hi everyone, this vignette is to introduce the package AnalysisLin, which is my personal package for exploratory data analysis. You can find the source package on my Github: [https://github.com/Zhiwei2799/AnalysisLin](https://github.com/Zhiwei2799/AnalysisLin)

There are several useful functions in this package, and table below summarize the functions that would be going over in this vignette
```{r,echo=FALSE}
library(knitr)
```
...
First function in package is desc_stat, it's a function that compute many useful statistical metrics so that you gain deep understanding of your data
...
These metrics provide valuable insights into the dataset in a deep level. If you don't want any of these metrics to be computed, you can set them to `FALSE`, so that the unwanted metrics wouldn't be shown in the output.

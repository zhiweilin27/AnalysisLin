...
# Introduction
Hi everyone, this vignette is to introduce the package AnalysisLin, which is my personal package for exploratory data analysis

There are several useful functions in this package, and table below summarize the functions that will be going over in this vignette
```{r,echo=FALSE}
library(knitr)
```
...
First function in package is desc_stat, it's a function that compute many useful statistical metrics so that you gain deeper understanding of your data
...
```
As can be seen, the descriptive statistics contain most, if not all, key statistical metrics for a dataset:
